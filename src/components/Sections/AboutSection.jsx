        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              >
                I believe technology should connect people and solve problems that matter. 
                My focus is on building digital experiences that are functional, engaging, and accessible to everyone.
              </p>
              <p
              ...
              >
                Outside of work, I explore emerging frameworks, contribute to open source, 
                and mentor new developers. I am inspired by the rapid evolution of web technologies and their power to create lasting impact.
              </p>
            </motion.div>

            {/* What I Love Building */}
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-medium mb-6">What I Love</h3>
            ...
            <motion.div variants={itemVariants} className="text-center py-8">
              ...
              {/* <div className="flex justify-center">
                <img src={SIGNATURE} alt="Udyotha" className="w-28" />
              </div> */}
