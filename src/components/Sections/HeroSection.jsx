        ...
        <div className="max-w-7xl mx-auto w-full z-10 mt-20">
          ...
          <div className="block lg:hidden">
            ...
            >
              ...
              >
                {[
                  { icon: FiGithub, href: "https://github.com/Udyotha" },
                  { icon: FiLinkedin, href: "https://www.linkedin.com/in/udyotha-sankalpana-534710152/" },
                  { icon: Mail, href: "mailto:udyotha@gmail.com" },
                ].map((social, index) => (
                  <motion.a
                    key={index}
                    href={social.href}
